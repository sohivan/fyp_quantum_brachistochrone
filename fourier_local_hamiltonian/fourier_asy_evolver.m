function [t_end,max_ent] = fourier_asy_evolver(coef,ent_targ,gz,w,H12,H1,H2,dt,terms)
    ...
    for j = 1:iter
		...
		fn_1 = coef(3:2:end)*[cos(n_space*t_holder) sin(n_space*t_holder)]';
        fn_2 = coef(4:2:end)*[cos(n_space*t_holder) sin(n_space*t_holder)]';
